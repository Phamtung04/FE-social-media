                            ...
                            <div className='h-[83vh]'>
                                ...
                                <div className='h-full space-y-4 mt-5 overflow-y-scroll hideScrollbar'>
                                    ...
                                    {reduxMessage.chat &&
                                        Array.from(
                                            new Map(
                                                reduxMessage.chat.map((chat) => {
                                                    const otherUser = chat.users.find(u => u.id !== auth.user.id); // lấy người còn lại trong chat
                                                    return [otherUser.id, {chat, otherUser}]; // dùng id user kia làm key để lọc trùng
                                                })
                                            ).values()
                                        ).map(({chat}) => (
                                            <div
